...
//Activa el evento, después del usuario seleccionar las fechas se debe calcular el valor de la reserva
                 fechaE = ((JTextField) txtFechaE.getDateEditor().getUiComponent()).getText();
                 fechaS = ((JTextField) txtFechaS.getDateEditor().getUiComponent()).getText();
				...
				try {
					...
					firstDate = sdf.parse(fechaE);
					secondDate = sdf.parse(fechaS);                                     
					...
					txtFormaPago.addActionListener (new ActionListener () {
					    public void actionPerformed(ActionEvent e) {
					    	String fPago = txtFormaPago.getSelectedItem().toString();
					...
					//cuando aprieto el btn tengo q guardar la reserva y traer ese num a el form de carga de huespedes 
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {		
                                        ...
                                        int t = Integer.valueOf(txtValor.getText());
                                       
                                       reservasService.crearReserva(fechaE,fechaS, t, txtFormaPago.getSelectedItem().toString());

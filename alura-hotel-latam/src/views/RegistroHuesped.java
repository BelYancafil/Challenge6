	...
	public RegistroHuesped() {
		...
		labelExit.setFont(new Font("Roboto", Font.PLAIN, 18));
                ...
                public void mouseClicked(MouseEvent e) {
                        ...
                        if (txtNombre.getText() != null && txtApellido.getText() != null && txtFechaN.getDate() != null && txtNacionalidad.getSelectedItem().toString()!= null) {		
                               String fechaNac = ((JTextField) txtFechaN.getDateEditor().getUiComponent()).getText();
                               int nRes = Integer.valueOf(txtNreserva.getText());
                               HuespedesServices.crearHuesped(txtNombre.getText(), txtApellido.getText(), txtNacionalidad.getSelectedItem().toString(), nRes, fechaNac, txtTelefono.getText());
                                JOptionPane.showMessageDialog(null, "Huesped guardado nro reserva: "+ txtNreserva.getText());
